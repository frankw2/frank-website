...
\item{\textbf{Frank Wang}, Yuna Joung, and James Mickens. ``Cobweb: Making Remote Attestation Practical Using Context-sensitive Dependencies." In proceedings of Workshop on System Software for Trusted Execution (SysTEX) 2017.}
